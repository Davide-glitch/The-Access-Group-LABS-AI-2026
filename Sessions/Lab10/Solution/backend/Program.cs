...
// NEW for Lab 10 — the quiz generator. Scoped, not Singleton like Lab 9's
// version: it now depends on IQuizRepository (Scoped, because DbContext
// isn't thread-safe to share) for the list_existing_quiz_titles tool, and a
// Singleton can't safely depend on a Scoped service (a "captive dependency"
// — it would pin the first request's DbContext for the app's whole lifetime).
