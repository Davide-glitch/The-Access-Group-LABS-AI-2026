...
// We are using Qdrant for persistence instead of InMemoryVectorStore
var qdrantClient = new QdrantClient("localhost");
var vectorStore = new QdrantVectorStore(qdrantClient, false); // Am adaugat false aici si am folosit var

var collection = vectorStore.GetCollection<Guid, Chunk>("company-docs");

// Check if the collection already exists to avoid re-ingesting on every run
...
{
    Console.WriteLine("Collection already exists — skipping ingestion.\n");
}
